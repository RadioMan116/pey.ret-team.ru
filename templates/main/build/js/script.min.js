...
! function (t) {
	...
	var e = /Android|iPhone|iPad|iPod|BlackBerry|WPDesktop|IEMobile|Opera Mini/i.test(navigator.userAgent),
		o = /iPhone|iPad|iPod/i.test(navigator.userAgent),
		i = -1 !== navigator.appVersion.indexOf("MSIE 10"),
		p = function (t, s) {
			var e = document.createElement("div");
			return e.className = t, s && s.appendChild(e), e
		};
	s.prototype = {
		options: function (t) {
			return this.defaults = this.extend({
				clearClose: !0,
				bodyHidden: !0,
				addClassNamePopup: "",
				closeOverlay: !0,
				...
				offsetX: 0,
				coordElement: ""
			}, t), this.defaults.background && (this.tags.popup.style.background = this.defaults.background), this
		},
		extend: function (t, s) {
		...
		addCloseButtons: function () {
			var t = this;
			this.defaults.closeButtons.split(",").forEach(function (s, e) {
				var o = document.querySelectorAll(s.replace(/\s+/g, ""));
				Array.prototype.forEach.call(o, function (s, e) {
					s.addEventListener(t.eventsTrigger, function (s) {
						return s.stopPropagation(), t.close(), !1
					}, !1)
				})
			})
		},
		coordSet: function () {
			var t = document.querySelector(this.defaults.coordElement);
			return t && (this.coords = t.getBoundingClientRect(), this.tags.popup__block.style.left = (this.defaults.bodyHidden ? 0 : window.pageXOffset) + this.coords.left + this.defaults.offsetX + "px", this.tags.popup__block.style.top = (this.defaults.bodyHidden ? 0 : window.pageYOffset) + this.coords.top + this.defaults.offsetY + "px", this.tags.popup__block.style.position = "absolute"), this
		},
		coordReset: function () {
			var t = this;
			return this.defaults = {
				...
				t.tags.popup.style.background = ""
			}, 500), this.tags.popup__block.style.left = "", this.tags.popup__block.style.top = "", this.tags.popup__block.style.position = "", this
		},
		setBodyStyle: function () {
			var t = window.innerHeight < document.body.scrollHeight;
			return this.defaults.bodyHidden && (document.body.classList.add("popup__body_hidden")),$('html').addClass('no-overflow'), this
		},
		clearBodyStyle: function () {
			return document.body.classList.remove("popup__body_hidden"),$('html').removeClass('no-overflow'), this
		},
		html: function (t, s) {
			return this.tags.popup__change.innerHTML = "", $(this.tags.popup__change).html(t), s && s.call(this.tags.popup, this.defaults, this.eventsTrigger), this
		},
		append: function (t, s) {
			return $(this.tags.popup__change).html(t), s && s.call(this.tags.popup, this.defaults, this.eventsTrigger), this.defaults.closeButtons && this.addCloseButtons(), this
		},
		clear: function (t) {
			return (this.defaults.clearClose || t) && (this.tags.popup__change.innerHTML = ""), this
		},
		show: function (t) {
			return this.defaults.closeShow ? this.tags.popup__close.style.display = "" : this.tags.popup__close.style.display = "none", this.setBodyStyle(), this.defaults.coordElement && this.coordSet(), this.defaults.closeButtons && this.addCloseButtons(), this.defaults.addClassNamePopup && this.tags.popup.classList.add(this.defaults.addClassNamePopup), this.tags.popup.classList.add("popup_active"), t && t.call(this.tags.popup, this.defaults, this.eventsTrigger), this
		},
		close: function (t) {
			var s = this;
			return setTimeout(function () {
				s.tags.popup.classList.remove("popup_active"), s.defaults.addClassNamePopup && s.tags.popup.classList.remove(s.defaults.addClassNamePopup), s.clear(), s.coordReset(), t && t.call(s.tags.popup, s.defaults, s.eventsTrigger), s.clearBodyStyle()
			}, 50), this
		},
		events: function () {
			var t = this;
			this.tags.popup__close.addEventListener(this.eventsTrigger, function (s) {
				return s.stopPropagation(), t.close(), !1
			}, !1), this.tags.popup__overlay.addEventListener(this.eventsTrigger, function (s) {
				return s.stopPropagation(), t.defaults.closeOverlay && t.close(), !1
			}, !1), document.addEventListener("keydown", function (s) {
				27 == s.which && t.close()
			}, !1)
		},
